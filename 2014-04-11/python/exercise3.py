...
glass_material = [0.1,0.4,0.3,0.5,  0,0,0,0.5,  2,2,2,0.5, 0,0,0,0.5, 100]
...
porte_main=COLOR(RED)(DIFFERENCE([porte_main, hole_porta]))
...
enclosures=STRUCT([enclosures, windows_main_2, windows_main_1, windows_hall, windows_wing_1])
...
stairs=T([1])([10])(STRUCT([step1,step2,step3, step4, step5]))
stairs2=T([1,2])([23,20.9])(R([1,2])(PI)(stairs))
